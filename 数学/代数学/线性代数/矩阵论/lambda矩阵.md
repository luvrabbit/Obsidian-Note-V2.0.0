...
## 行列式因子法 
**行列式因子**记为$D_{i}(\lambda),i=1,2,\dots r$ $r$为秩
...
## 初等因子
**各阶不变因子可以做因式分解为多个$\lambda$多项式乘积，其中*每个因式称为$A(\lambda)$的初等因子***
将每个这样因式分解得到的$\lambda$多项式成组排列，称为初等因子组
要注意，初等因子组中的初等因子可以有重复，而且如果有重复的时候必须重复
